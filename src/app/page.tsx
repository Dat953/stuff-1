  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white font-sans selection:bg-purple-500 selection:text-white pb-12">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-600 font-medium mt-0.5">
                Made by <span className="text-purple-400 font-bold">Le Minh Dat</span>
              </p>
            </div>
          </div>
      ...
      <footer className="relative z-10 mt-10 pb-6 text-center">
        <div className="inline-flex items-center gap-3 bg-slate-900/70 backdrop-blur-md border border-slate-800 rounded-2xl px-6 py-3 shadow-lg">
          <span className="text-slate-500 text-xs">Made with ❤️ by</span>
          <span className="text-sm font-bold text-purple-300">Le Minh Dat</span>
          <span className="text-slate-700">|</span>
          <a
            href="https://github.com/Dat953/stuff-1"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-1.5 text-xs font-semibold text-slate-400 hover:text-white transition-colors duration-200 group"
          >
            <svg className="w-4 h-4 fill-current group-hover:text-purple-400 transition-colors" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
